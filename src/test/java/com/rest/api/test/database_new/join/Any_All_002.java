...
public class Any_All_002 {

    public static void main(String args[]){ // SQL statement returns TRUE and lists the product names if it finds ANY records in the OrderDetails table that quantity > 70
        try{
            ...
            ResultSet rs = stmt.executeQuery("SELECT customerNumber\n" +
                    "    FROM Orders\n" +
                    "    WHERE orderNumber = ANY (SELECT orderNumber FROM OrderDetails WHERE quantityOrdered > 70)");
