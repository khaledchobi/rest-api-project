...
public class Having_002 {
    public static void main(String args[]){ // SQL statement lists the number of customers in each country, sorted high to low (Only include countries with more than 5 customers
        try{
