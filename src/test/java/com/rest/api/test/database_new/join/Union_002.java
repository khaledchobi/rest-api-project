...
public class Union_002 {

    public static void main(String args[]){ // Union All // SQL statement returns the cities (duplicate values also) from both the "Customers" and the "Suppliers" table
        try{
