...
public class Union_004 {

    public static void main(String args[]){ // UNION ALL With WHERE // SQL statement returns the German cities (duplicate values also) from both the "Customers" and the "Suppliers" table
        try{
