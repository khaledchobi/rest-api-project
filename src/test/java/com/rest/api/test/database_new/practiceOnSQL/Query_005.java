...
public class Query_005 {

    public static void main(String args[]){ // Second highest with checkNumber
        try{
            ...
            ResultSet rs=stmt.executeQuery("SELECT checkNumber FROM Customers.payments\n" +
